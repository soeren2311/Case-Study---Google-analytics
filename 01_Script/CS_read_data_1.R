...
2. How could these trends apply to Bellabeat customers?
  ...
  important part in the people's daily life. Therefore, the probability is high that this trend will continue
...
###################################################################################################
 ...
 Which dataset will be used for the analysis?
    ...
    - These datasets were generated by respondents to a distributed survey via Amazon Mechanical Turk 
      between 03.12.2016-05.12.2016. Thirty eligible Fitbit users consented to the submission of personal 
